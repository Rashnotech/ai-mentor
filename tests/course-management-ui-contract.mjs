...
assert.doesNotMatch(learnPage, /truncate text-\[13px\] font-semibold leading-snug/)
assert.doesNotMatch(learnPage, /line-clamp-1 .*text-\[11px\] leading-4 text-gray-500/)
assert.doesNotMatch(learnPage, /line-clamp-2 .*text-\[11px\] leading-4 text-gray-600/)

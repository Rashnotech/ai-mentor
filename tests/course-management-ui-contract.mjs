...
assert.match(learnPage, /w-full min-w-0 max-w-full rounded-lg border px-2\.5 py-2 text-left/)
assert.match(learnPage, /w-full min-w-0 max-w-full rounded-xl border border-gray-200 bg-white/)
...
assert.match(learnPage, /sticky top-24 h-\[calc\(100vh-7rem\)\] rounded-3xl/)
assert.doesNotMatch(learnPage, /w-full min-w-0 max-w-full overflow-hidden rounded-(lg|xl)/)
assert.doesNotMatch(learnPage, /flex h-full min-w-0 min-h-0 flex-col overflow-hidden/)
assert.doesNotMatch(learnPage, /sticky top-24 h-\[calc\(100vh-7rem\)\] overflow-hidden/)

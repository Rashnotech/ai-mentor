...
assert.match(learnPage, /w-full max-w-full overflow-hidden rounded-xl border p-3 text-left/)
assert.match(learnPage, /truncate text-sm font-semibold leading-snug/)
assert.match(learnPage, /line-clamp-3 break-words px-1 py-2 text-xs leading-5 text-gray-600/)

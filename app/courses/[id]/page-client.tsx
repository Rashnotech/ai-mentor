...
export default function CourseDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-20 pt-16">
      {/* Navbar */}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/5 bg-[#1a1f2e]/95 backdrop-blur-md">
            <div className="flex flex-col px-6 py-4 gap-1">
              <Link href="/courses" onClick={() => setMobileMenuOpen(false)} className="py-3 text-sm font-medium text-gray-300 hover:text-white transition-colors">
                Courses
              </Link>

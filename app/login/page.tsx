...
import { Github, Eye, EyeOff, CheckCircle2, Shield } from "lucide-react"
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white text-gray-900 font-sans overflow-y-auto">
      {/* Left Side - Hero (Identical to Signup for consistency) */}
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-20 xl:px-32 bg-white overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg py-2.5 text-sm text-gray-700 transition-all shadow-sm">
          ...
          <div className="mt-6 p-3 bg-purple-50 border border-purple-100 rounded-lg">
            <div className="flex items-center gap-2 text-xs text-purple-700">
              ...
              <span>Admin? Use email containing "admin" to access admin panel</span>
            </div>
          </div>
        </div>
      </div>

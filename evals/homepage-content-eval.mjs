...
const checks = [
  ...
  ["company logo strip replaced by reviews", page.includes("studentReviews.slice(0, 6).map") && !page.includes("Explore the Companies Investing in our Talent")],
  ...
  ["reviews use light cards", page.includes("border border-blue-100 bg-white") && !page.includes("bg-[#142235]")],

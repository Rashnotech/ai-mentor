...
const checks = [
  ...
  ["mentor section follows the reference layout", page.includes("const mentors = [") && page.includes("Learn from experts at Rashnotech") && page.includes("mentors.map") && page.includes('className="bg-[#f6f8ff] py-16 md:py-24"')],
